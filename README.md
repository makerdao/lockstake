...
* This version removes the on-demand window function, that exists in the previous one, as the flash loan protection has been improved in the new Chief version.
